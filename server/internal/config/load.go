...
func defaultValues() map[string]interface{} {
	return map[string]interface{}{
		...
		"mqtt.enabled":                           false,
		"mqtt.protocol":                          MQTTProtocol5,
		"mqtt.client_id":                         "edge-platform-server",
		"mqtt.prefix":                            "edge",
		"mqtt.keepalive":                         "30s",
		"mqtt.connect_timeout":                   "10s",
		"mqtt.reconnect_min":                     "1s",
		"mqtt.reconnect_max":                     "30s",
		"mqtt.session_expiry":                    "24h",
		"mqtt.max_payload_bytes":                 1048576,
		"mqtt.reliable_queue_size":               1024,
		"mqtt.raw_queue_size":                    256,
		"mqtt.consumer_timeout":                  "5s",
		"mqtt.shutdown_timeout":                  "10s",
	}
}
